...
$email = 'contato@midnadigital.com.br';
...
try {
	...
	$mail->Host = 'email-ssl.com.br';				       // Specify main and backup server
	$mail->SMTPAuth = false;                                  // Enable SMTP authentication
	$mail->Username = 'contato@midnadigital.com.br';                    // SMTP username
	$mail->Password = 'Midna@2020';                              // SMTP password
