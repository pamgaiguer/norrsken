            ...
            <div class="row justify-content-between">
              <div class="col-sm-12 col-lg-6 col-xl-6">
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="100">
                  <h4 class="custom-font-primary custom-newsletter-title font-weight-bold mb-4 custom-text-7">Fique por dentro das novidades!</h4>
                  <div class="alert alert-success d-none" id="newsletterSuccess">
                    <strong>Feito!</strong> entraremos em contato.
                  </div>
                  ...
                  <form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="mr-0 mb-3 mb-md-0 opacity-10">
                    <div class="input-group custom-newsletter">
                      <input class="form-control form-control-sm custom-newsletter-input rounded-0 bg-transparent border-0 pl-0 custom-text-2 text-color-light box-shadow-none" placeholder="Endereço de E-mail" name="newsletterEmail" id="newsletterEmail" type="text">
                      <span class="input-group-append">
                        <button class="btn text-color-light custom-text-4 font-weight-semibold custom-btn-with-arrow custom-btn-with-arrow-light" type="submit">Enviar</button>
                      </span>
                    </div>
                  </form>
                </div>
            ...
            <div class="row justify-content-between">
                        ...
                        <div class="footer-nav footer-nav-links">
                          <nav>
                            <ul class="nav" id="footerNav">
                              ...
                              <li>
                                <a class="text-color-hover-primary font-weight-semibold custom-text-2 text-capitalize" href="sobre.html">A Orbit</a>
                              </li>
                                                          <li>
                                <a class="text-color-hover-primary font-weight-semibold custom-text-2 text-capitalize" href="http://orbitaudiovisual.com.br#paineldeled">Serviços</a>
                              </li>
                                                          <li>
                                <a class="text-color-hover-primary font-weight-semibold custom-text-2 text-capitalize" href="http://www.orbitaudiovisual.com.br#lives">Evento Online</a>
                              </li>
                              <li>
                                <a class="text-color-hover-primary font-weight-semibold custom-text-2 text-capitalize" href="contato.html">Contato</a>
                              </li>
                            </ul>
                          </nav>
                        </div>			
              ...
              <div class="col-sm-12 col-lg-5 col-xl-6">
                <div class="d-flex justify-content-end custom-footer-copywriting pt-5 mt-0 mt-lg-4">
                  <p class="mb-0 text-left text-lg-right d-block w-100 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">Orbit. ©  2021.  All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
